...
export async function POST(req: Request) {
  ...
  // player_died and turn_passed are marker events with delta=0; other events require non-zero delta
  if (delta === 0 && event_type !== 'player_died' && event_type !== 'turn_passed') {
