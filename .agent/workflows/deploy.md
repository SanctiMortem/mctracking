...
> 🔴 **04_complementary §7b aplica:** NUNCA pushear a main sin autorización explícita del usuario.
...
3. **NUNCA** pushear a main sin autorización explícita (regla §7b).
...
7. **Primer release** = explícito con `/deploy release`. Transición de 0.0.0 a versión real.

---

_TimeKast Factory — Deploy Workflow v1.0_
