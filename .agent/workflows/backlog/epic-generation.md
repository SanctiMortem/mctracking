...
- Metadata block: Status, Priority, Effort, SP, Epic, Blocked By, Skills, Agents, **Owner**
...
3. Llenar TODAS las secciones (no placeholders):
   - Metadata block (Status, Priority, Effort, SP, Epic, Blocked By, Skills, Agents)
...
- [ ] Metadata block completo (9 campos: Status, Priority, Effort, SP, Epic, Blocked By, Skills, Agents, **Owner**)
