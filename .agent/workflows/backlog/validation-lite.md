...
for GENERATED in $GENERATED_FILES; do
  if [ -f "$GENERATED" ]; then
    ...
    grep -q "> **Status:**" "$GENERATED" && echo "   ✅ Status" || echo "   ❌ Status falta"
    grep -q "> **Priority:**" "$GENERATED" && echo "   ✅ Priority" || echo "   ❌ Priority falta"
    grep -q "> **Story Points:**" "$GENERATED" && echo "   ✅ Story Points" || echo "   ❌ Story Points falta"
    grep -q "> **Epic:**" "$GENERATED" && echo "   ✅ Epic" || echo "   ❌ Epic falta"
