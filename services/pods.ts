...
export async function listPodDecks(groupId: string): Promise<PodDeck[]> {
  ...
  const rows = await db
    .select({
      ...
      // Commander 1
      c1Id: cmd1.id,
      c1ScryfallId: cmd1.scryfallId,
      c1Name: cmd1.name,
      c1ColorIdentity: cmd1.colorIdentity,
      c1ArtCrop: cmd1.artCrop,
      ...
      // Commander 2
      c2Id: cmd2.id,
      c2ScryfallId: cmd2.scryfallId,
      c2Name: cmd2.name,
      c2ColorIdentity: cmd2.colorIdentity,
      c2ArtCrop: cmd2.artCrop,
