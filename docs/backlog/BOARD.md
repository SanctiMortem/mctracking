...
| EPIC-04 | History & Stats | 13 | 52 | 1 | 12 | 🔄 In Progress |
| EPIC-05 | Platform | 18 | 68 | 0 | 18 | 📋 Planning |
| **M1 Total** | — | **72** | **289** | **41** | **31** | — |

**Progress:** 42/72 issues done (58%) · 170/289 SP completed (59%)
...
## EPIC-04 — History & Stats 📋 Planning

> 13 issues · 52 SP · 0% complete
> **Dependency:** EPIC-02 ✅, EPIC-03 ✅ — **Ready to start**

| ID | Title | Priority | SP | Status |
|----|-------|----------|----|--------|
| ADR-008 | Match History Pagination — Cursor vs Offset | P2 | 1 | ✅ Done |
| HIST-001 | API — Match History (GET /matches + filters) | P1 | 5 | 📋 Backlog |
...
| HIST-010 | API — Matchup Stats + Global Stats | P1 | 5 | 📋 Backlog |
| HIST-011 | UI — SCR-006 Stats Dashboard + SCR-015 Matchup Stats | P1 | 8 | 📋 Backlog |
| HIST-012 | 🧪 Epic Tests — History & Stats | P1 | 5 | 📋 Backlog |
...
**EPIC-04 — In Progress:**
`HIST-001` `HIST-002` `HIST-003` `HIST-004` `HIST-005` `HIST-006` `HIST-007` `HIST-008` `HIST-009` `HIST-010` `HIST-011` `HIST-012`
