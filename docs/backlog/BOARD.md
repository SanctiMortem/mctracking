...
**Progress:** 46/72 issues done (64%) · 190/289 SP completed (66%)
...
`ADR-008` `HIST-001` `HIST-002` `HIST-003` `HIST-004`

### 📋 Backlog (31 issues · 120 SP)

**EPIC-04 — In Progress:**
`HIST-005` `HIST-006` `HIST-007` `HIST-008` `HIST-009` `HIST-010` `HIST-011` `HIST-012`
