...
**Progress:** 49/72 issues done (68%) · 199/289 SP completed (69%)
...
`ADR-008` `HIST-001` `HIST-002` `HIST-003` `HIST-004` `HIST-005` `HIST-006` `HIST-007`

### 📋 Backlog (31 issues · 120 SP)

**EPIC-04 — In Progress:**
`HIST-008` `HIST-009` `HIST-010` `HIST-011` `HIST-012`
