...
| EPIC-04 | History & Stats | 13 | 52 | 4 | 9 | 🔄 In Progress |
| EPIC-05 | Platform | 18 | 68 | 0 | 18 | 📋 Planning |
| **M1 Total** | — | **72** | **289** | **41** | **31** | — |

**Progress:** 51/72 issues done (71%) · 203/289 SP completed (70%)
...
`ADR-008` `HIST-001` `HIST-002` `HIST-003` `HIST-004` `HIST-005` `HIST-006` `HIST-007` `HIST-008` `HIST-009`

### 📋 Backlog (31 issues · 120 SP)

**EPIC-04 — In Progress:**
`HIST-010` `HIST-011` `HIST-012`
