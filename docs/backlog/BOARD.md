...
**Progress:** 52/72 issues done (72%) · 208/289 SP completed (72%)
...
`ADR-008` `HIST-001` `HIST-002` `HIST-003` `HIST-004` `HIST-005` `HIST-006` `HIST-007` `HIST-008` `HIST-009` `HIST-010`
